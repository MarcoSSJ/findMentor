...
public class HomeFragment extends Fragment {
    ...
    public void onResume() {
        ...
        if(sessionID.equals("")) {
            ...
            textView_school.setVisibility(View.INVISIBLE);
            ...
            textView_school.setVisibility(View.VISIBLE);
        ...
        public void run() {
            ...
            Handler handler = new Handler(Looper.getMainLooper()) {
                ...
                public void handleMessage(Message msg) {
                    ...
                    if (msg.what == 0) {
                        //不成功，弹窗
                        Toast toast = Toast.makeText(getActivity().getApplicationContext(), "获取失败", Toast.LENGTH_SHORT);
                        toast.show();
                    } else if (msg.what == 1) {
